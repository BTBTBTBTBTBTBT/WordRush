      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="space-y-4">
          ...
          <div style={{ background: 'var(--color-surface)', border: '1.5px solid var(--color-border)', borderRadius: '16px' }} className="p-5">
            ...
            <p className="text-xs leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
              Your daily score is a composite of three factors: a <span className="font-bold" style={{ color: 'var(--color-text)' }}>base score</span> of 1,000 points for completing the puzzle, a <span className="font-bold" style={{ color: 'var(--color-text)' }}>guess bonus</span> for using fewer guesses than the maximum allowed, and a <span className="font-bold" style={{ color: 'var(--color-text)' }}>speed bonus</span> for finishing quickly. Multi-board modes also include a <span className="font-bold" style={{ color: 'var(--color-text)' }}>completion bonus</span> based on how many boards you solved. For example, in Classic with 4 guesses and 13 seconds: 1,000 base + 200 guess bonus (2 unused guesses &times; 100) + 287 speed bonus (300s cap &minus; 13s) + 200 completion = 1,687 points. The fewer guesses and less time you take, the higher your score.
            </p>
          </div>
