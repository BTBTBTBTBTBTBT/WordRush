...
export const FAQ_SECTIONS: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I score higher on the leaderboard?', a: 'Daily rank is a composite of how few guesses you used and how fast you solved. Solving in fewer guesses matters most, but speed breaks ties — so know your opening word cold and do not overthink the easy boards. Even on a loss you bank partial credit for progress — extra correct letters on a single board, boards solved on the multi-board modes, or stages reached in the Gauntlet — so getting close still counts.' },
    ],
  },
  {
...
export const HELP_MODES: HelpMode[] = [
  ...
  { title: 'VS Battle', desc: 'Race a friend, a live opponent, or a bot in real time. First to solve wins.', accent: '#0d9488' },
...
export const ABOUT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Every completed puzzle earns a score based on three factors, in order of weight: a base score for solving the puzzle, a guess bonus for every attempt you did not need, and a speed bonus for finishing quickly. Guesses dominate — the speed bonus is always worth less than a single guess, so it breaks ties among equally efficient solvers rather than beating them. Even a loss earns a little partial credit for progress — correct letters on a single board, boards solved on the multi-board modes, or stages reached in the Gauntlet.',
...
export const SUPPORT_SECTIONS: ContentSection[] = [
  ...
  { heading: 'How do I cancel my Pro subscription?', paragraphs: ['Open Settings and tap Manage Subscription — it takes you to wherever you subscribed (the App Store, Google Play, or our web billing portal), where you can cancel in a couple of taps. Once cancelled, you keep Pro access until the end of your current billing cycle. No questions asked, no hidden fees.'] },
