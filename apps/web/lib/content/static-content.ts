...
export const ABOUT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Every completed puzzle earns a score based on three factors: a base score for solving the puzzle, a guess bonus for using fewer attempts, and a speed bonus for finishing quickly. Fewer guesses and faster times produce higher scores. Even a loss earns a little partial credit for progress — correct letters on a single board, boards solved on the multi-board modes, or stages reached in the Gauntlet.',
