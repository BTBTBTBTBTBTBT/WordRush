...
describe('bundled word-list copies are identical everywhere', () => {
  ...
  for (const bank of ['ladder-puzzles.json', 'wordsearch-puzzles.json', 'hub-puzzles.json', 'cryptogram-puzzles.json', 'groups-puzzles.json', 'crossword-puzzles.json', 'scramble-puzzles.json', 'holiday-days.json']) {
    it(bank, () => {
