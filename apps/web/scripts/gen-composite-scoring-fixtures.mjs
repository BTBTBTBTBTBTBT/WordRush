...
const CASES = [
  ...
  // More Games (Stage 3): perfect, typical and hinted runs, plus a loss per semantics family.
  ['sudoku win, 0 mistakes',     'SUDOKU',        true,  1, 238, 1, 1,  0, null, null],
  ['sudoku win, 2 mistakes, hint','SUDOKU',       true,  3, 900, 1, 1,  1, null, null],
  ['sudoku loss (3 mistakes)',   'SUDOKU',        false, 4, 600, 0, 1,  0, null, 0],
  ['muddle perfect (5 checks)',  'SCRAMBLE',      true,  5, 112, 5, 5,  0, null, null],
  ['muddle win, 8 checks, hint', 'SCRAMBLE',      true,  8, 300, 5, 5,  1, null, null],
  ['muddle loss 3/5',            'SCRAMBLE',      false, 13, 480, 3, 5,  0, null, null],
  ['hubbub pandemonium',         'HUB',           true,  1, 1500, 20, 20, 0, null, null],
  ['hubbub rank 4 (Hubbub)',     'HUB',           true,  4, 600, 10, 20, 0, null, null],
  ['hubbub loss (gave up)',      'HUB',           false, 8, 300, 4, 20, 0, null, null],
  ['crossword clean',            'CROSSWORD',     true,  1, 200, 1, 1,  0, null, null],
  ['crossword 2 checks 1 hint',  'CROSSWORD',     true,  3, 500, 1, 1,  1, null, null],
  ['kindred perfect',            'GROUPS',        true,  4, 90,  4, 4,  0, null, null],
  ['kindred 2 mistakes, hint',   'GROUPS',        true,  6, 240, 4, 4,  1, null, null],
  ['kindred loss 2/4',           'GROUPS',        false, 6, 300, 2, 4,  0, null, null],
  ['ladder on par',              'LADDER',        true,  1, 75,  1, 1,  0, null, null],
  ['ladder +2 over par, hint',   'LADDER',        true,  3, 240, 1, 1,  1, null, null],
  ['codebreaker no checks',      'CRYPTOGRAM',    true,  1, 125, 1, 1,  0, null, null],
  ['codebreaker 1 check 1 hint', 'CRYPTOGRAM',    true,  2, 400, 1, 1,  1, null, null],
  ['spyglass clean',             'WORDSEARCH',    true,  10, 165, 10, 10, 0, null, null],
  ['spyglass 3 misses',          'WORDSEARCH',    true,  13, 400, 10, 10, 0, null, null],
