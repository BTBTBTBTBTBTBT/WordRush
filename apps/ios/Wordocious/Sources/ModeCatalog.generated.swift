...
enum ModeGen {
    static let all: [GenMode] = [
        ...
        GenMode(id: "propernoundle", dbKey: "PROPERNOUNDLE", title: "ProperNoundle", shortTitle: "Proper", shareLabel: "ProperNoundle", desc: "Guess famous names", accentHex: "#dc2626", glyph: "P", romanNumeral: nil, dailyEligible: true, group: "more", sweep: false, engine: "custom", guessSemantics: "guesses", guessBase: 1, enabled: true, flagKey: nil, category: "trivia", guideSlug: "propernoundle"),
        GenMode(id: "more", dbKey: nil, title: "More Games", shortTitle: "More", shareLabel: "More Games", desc: "Sudocious, Muddle and more", accentHex: "#4f46e5", glyph: "+", romanNumeral: nil, dailyEligible: false, group: "core", sweep: false, engine: "custom", guessSemantics: "guesses", guessBase: 1, enabled: true, flagKey: "menu.more", category: nil, guideSlug: nil),
