...
object ModeGen {
    val all: List<GenMode> = listOf(
        ...
        GenMode("more", null, "More Games", "More", "More Games", "Sudocious, Muddle and more", "#4f46e5", "+", null, false, "core", false, "custom", "guesses", 1, true, "menu.more", null, null),
        GenMode("sudoku", "SUDOKU", "Sudocious", "Sudocious", "Sudocious", "Daily number logic", "#1e40af", "9", null, true, "more", false, "custom", "mistakes", 1, true, "mode.sudoku", "logic", "sudocious"),
